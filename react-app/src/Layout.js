        ...
        <nav className='navbar navbar-expand-lg bg-body-indigo text-white' style={primary}>
            <span className="container-fluid pe-5">
                ...
                <span className="navbar-nav d-flex" id="collapseNavItems">
                    {!loginStatus && <div className="nav-item"><Link className="nav-link text-white" to="/login">Login</Link></div>}
                    ...
                    {loginStatus && <Link className="nav-item nav-link text-white" to="/addDashboard">Create</Link>}
